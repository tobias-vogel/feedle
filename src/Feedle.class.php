...
//    $result .= "    <span onclick="activateFeedsTab()">Feeds</span>\n";
  ...
  public function displayFeedPage($feeds, $timestamp) {
    ...
    $content =
      "<p><div class=\"clear-block\"><a class=\"button\" href=\"#\" onclick=\"openRandomFeedItem(); return false;\" title=\"Open random feed item\"><img src=\"assets/random.png\" alt=\"Dies\" width=\"150\"/><br/>Open random feed item</a></div><div class=\"clear-block\"><a class=\"button\" href=\"#\" onclick=\"openRandomFeedItemAndRemovePreviousRandomFeedItem(); return false;\" title=\"Open random feed item and remove previous radnom feed item\"><img src=\"assets/random.png\" alt=\"Dies\" width=\"150\"/><br/>Open random feed item and remove previous random feed item</a></div></p>\n" . 
